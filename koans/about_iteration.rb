...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # for every item in the array it computes what is in the curly brackets iteratively, starting with what in the inject.
  end
  ...
  #   # code to read 'file'
  # So that you aren't directly changing the file, just taking information from it
