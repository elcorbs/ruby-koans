...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # THINK ABOUT IT:
    #
    # When would * fail to match? If it isn't a string?
  end
  ...
  # A character class can match to a randon order of the character, whereas an alternation matches ones of the options exactly
